...
def test_get_embedding_valid_input():
...
def test_get_embedding_whitespace_input():
...
def test_get_embedding_long_input():
...
def test_get_embedding_special_chars():
...
@pytest.mark.asyncio
async def test_get_embedding_concurrent():
